  ...
  return (
    <html lang="en">
      ...
      <body>
        ...
        `}</Script>
        {/* Cal.com namespace initializers */}
        <CalNamespaceInit
          namespace="consult"
          uiOptions={{ cssVarsPerTheme: { light: { 'cal-brand': '#3e885b' } }, hideEventTypeDetails: false, layout: 'month_view' }}
        />
        <CalNamespaceInit
          namespace="tenant"
          uiOptions={{ hideEventTypeDetails: false, layout: 'month_view' }}
        />
        <HashNavigation />
