...
const mockProperties = [
  ...
  },
  {
    ...
    type: 'Mixed Use',
    agent: 'Lauren Davis',
    image: 'https://images.unsplash.com/photo-1467803738586-46b7eb7b16a1?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    badges: [
      { text: 'For Sale', color: 'bg-[#CDDC39]' },
...
export default function FeaturedProperties({ block }: FeaturedPropertiesProps) {
  const heading = block.heading || 'Featured Properties'
  const seeAllLink = block.seeAllLink || '/property-search'
    ...
    <section className="max-w-[1400px] mx-auto px-4 py-16 md:py-24 font-sans text-[#1C2B28]">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
        <div>
          ...
          <h2 className="text-4xl md:text-5xl font-serif leading-tight">{heading}</h2>
        </div>
