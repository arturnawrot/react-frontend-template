        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-4 mb-20 text-sm items-start">
            ...
            <div className="flex flex-col gap-3">
              <a href="#" className="hover:text-[#dce567] transition w-fit outline-none border-none">Buy</a>
              <a href="#" className="hover:text-[#dce567] transition w-fit outline-none border-none">Lease</a>
              <a href="#" className="hover:text-[#dce567] transition w-fit outline-none border-none">Sell</a>
              <a href="#" className="hover:text-[#dce567] transition w-fit outline-none border-none">Insights & Research</a>
            </div>

            {/* Column 2 */}
            <div className="flex flex-col gap-3">
              <a href="#" className="hover:text-[#dce567] transition w-fit outline-none border-none">Our Agents</a>
              <a href="#" className="hover:text-[#dce567] transition w-fit outline-none border-none">Our Advantage</a>
              <a href="#" className="hover:text-[#dce567] transition w-fit outline-none border-none">Our Services</a>
              <a href="#" className="hover:text-[#dce567] transition w-fit outline-none border-none">Our Company</a>
            </div>

            {/* Column 3 */}
            <div className="flex flex-col gap-3">
              <a href="#" className="hover:text-[#dce567] transition w-fit outline-none border-none">Account Login</a>
              <a href="#" className="hover:text-[#dce567] transition w-fit outline-none border-none">Contact Us</a>
              <a href="#" className="hover:text-[#dce567] transition w-fit outline-none border-none">Schedule a Tour / Consultation</a>
            </div>
